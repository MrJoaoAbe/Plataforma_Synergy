            ...
            {usuarioLogado.darkMode === true ? <div className="bg-[#DFDFDF] min-h-screen flex items-center justify-center">
                    ...
                    <div className="flex juflex flex-row items-center justify-between px-10stify-around">
                        ...
                        <div className="flex flex-row mr-30 mt-20 gap-5">
                            <button
                                ...
                                className={`w-14 h-8 rounded-full flex items-center px-1 transition duration-300 shadow-2xl mb-6 
                ${ativado ? "bg-[#859F74] justify-end " : "bg-[#DFDFDF] justify-start "}`}
                            >
                ...
                <div className="bg-[#111411] min-h-screen flex items-center justify-center">
                    <div className="w-350  bg-[#1A1D1A] rounded-4xl shadow-2xl flex flex-col">
                        <div className="flex juflex flex-row items-center justify-between px-10stify-around">
                            <h1 className="font-extralight text-4xl text-white p-20 pb-0 flex items-center ml-10">MEU PERFIL</h1>
                            <div className="flex flex-row mr-30 mt-20 gap-5">
                                <button
                                    onClick={() => {
                                        alternarDarkMode();
                ...
                ${ativado ? "bg-[#859F74] justify-end " : "bg-[#DFDFDF] justify-start "}`}
                        ...
                        <div className="grid grid-cols-3 gap-6 items-center p-20 px-40 text-white">
                            ...
                            <p className="mt-6 col-start-1 col-span-2 text-white text-center text-lg">
                                {usuarioLogado === null ? '' : usuarioLogado.resumo}
                            </p>
                            ...
                            <div className="flex flex-col col-start-3 items-center gap-4">
                                <Link to="/dashboard" className="font-semibold bg-[#859F74] p-5 py-2 rounded-2xl text-white border-4 border-[#859F74] flex items-center justify-center shadow hover:bg-white hover:text-[#859F74] transition ">
                                    VISUALIZAR DASHBOARD
                                </Link>
                                <Link to='/' onClick={handleClick} className="font-semibold bg-[#ff0000] px-6 py-2 rounded-2xl text-[#ffffff] border-2 border-[#ff0000] flex items-center justify-center shadow hover:bg-[#ffffff] hover:text-[#ff0000] transition w-fit">
                                    SAIR
                                </Link>
