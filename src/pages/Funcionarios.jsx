        ...
        <div>
            {usuarioLogado.darkMode === false ?
                ...
                <div className="bg-[#EDEBEB] min-h-screen rounded-4xl shadow-2xl flex flex-col">
                    <h1 className="font-extralight text-4xl text-[#859F74] py-15 lg:p-15 pb-5 flex items-center ml-10">
                        FUNCIONÁRIOS
                    </h1>
                ...
                <div className="bg-[#1A1D1A] min-h-screen rounded-4xl shadow-2xl flex flex-col">
                    <h1 className="font-extralight text-4xl text-[#ffffff] py-15 lg:p-15 pb-5 flex items-center ml-10">
                        FUNCIONÁRIOS
                    </h1>
