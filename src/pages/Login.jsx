            ...
            <div className="w-200 h-200 bg-white rounded-4xl shadow-2xl flex flex-col">
                ...
                <div>
                    <form className="flex flex-col items-center gap-5">
                        <input type="text" className="w-130 border-gray-200 border-4 h-13 rounded-3xl shadow-2xl pl-5 placeholder:text-[#859F74] placeholder:text-lg mb-10" placeholder="Email" />
