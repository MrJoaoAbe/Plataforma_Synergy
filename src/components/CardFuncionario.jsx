            ...
            {usuarioLogado.darkMode === false ?
                ...
                <div className="flex flex-col items-center justify-center bg-white rounded-4xl p-5 lg:p-10 mt-5 lg:m-20 mb-0 shadow-2xl">
                    ...
                    <div className="flex flex-row items-center gap-4 mt-5">
                        ...
                        <Link to="/mensagemDireta" className=" bg-white py-1 w-20 lg:w-60 rounded-2xl text-sm lg:text-md text-[#859F74] border-2 border-[#859F74] flex items-center justify-center shadow hover:bg-[#859F74] hover:text-white transition ">
                            ENVIAR MENSAGEM
                        </Link>
                    </div>
                </div>
