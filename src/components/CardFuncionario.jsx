    ...
    return (
        ...
        <div>
            {usuarioLogado.darkMode === false ?
                //modo claro
                <div className="flex flex-col items-center justify-center bg-white rounded-4xl p-2 lg:p-10 mt-5 lg:m-20 mb-0 shadow-2xl">
                    <div className="flex flex-row gap-5">
                        <img src={foto === null ? profileSemFoto : foto} className="w-20 lg:w-25 rounded-full" />

                        <div className="flex flex-col text-[#859F74]">
                            <p className="text-lg lg:text-2xl">{nome}</p>
                            <div className="flex flex-row gap-5">
