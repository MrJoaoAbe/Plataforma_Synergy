    ...
    return (
        ...
        <div>
            {usuarioLogado.darkMode === false ?
                //modo claro
                <div className="flex flex-col items-center justify-center bg-white rounded-4xl lg:p-10  lg:m-20 my-5 mb-0 shadow-2xl">
                    <div className="flex flex-row gap-5">
                        <img src={foto === null ? profileSemFoto : foto} className="w-20 lg:w-25 rounded-full" />

                        <div className="flex flex-col text-[#859F74]">
                            <p className="text-xl lg:text-2xl">{nome}</p>
                            <div className="flex flex-row gap-5">
                    ...
                    <div className="flex flex-row items-center gap-4 mt-5">
                        ...
                        <button
                            ...
                            className="bg-white py-1 w-40 lg:w-60 rounded-2xl text-[#859F74] border-2 border-[#859F74] flex items-center justify-center shadow hover:bg-[#859F74] hover:text-white transition ">
                            ENVIAR MENSAGEM
                        </button>
                    </div>
                </div>
                :
                //modo escuro
                <div className="flex flex-col items-center justify-center bg-[#111411] rounded-4xl lg:p-10  lg:m-20 my-5 mb-0 shadow-2xl">
                    <div className="flex flex-row gap-5">
                        <img src={foto === null ? profileSemFoto : foto} className="w-20 lg:w-25 rounded-full" />

                        <div className="flex flex-col text-[#ffffff]">
                            <p className="lg:text-2xl">{nome}</p>
                            <div className="flex flex-row gap-5">
                                <p className="text-lg lg:text-2xl">{area}</p>
                                <p className="text-lg lg:text-2xl">{localizacao}</p>
                            </div>
                    ...
                    <div className="flex flex-row items-center gap-4 mt-5">
                        ...
                        <Link to={`/mensagemDireta/${id}`} className=" bg-[#859F74] py-1 w-40 lg:w-60 rounded-2xl text-[#ffffff] border-2 border-[#859F74] flex items-center justify-center shadow hover:bg-[#ffffff] hover:text-[#859F74] transition ">
                            ENVIAR MENSAGEM
                        </Link>
                    </div>
                </div>}
