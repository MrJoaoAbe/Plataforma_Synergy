    ...
    return (
        <div>
            {usuarioLogadoLocalStorage.darkMode === false ?
                //modo claro
                <div className="flex flex-col items-center justify-center bg-white rounded-4xl p-2 lg:p-10 lg:mx-20 my-5 shadow-2xl">
                    ...
                    <div className="flex flex-row items-center gap-4 mt-5">
                        <Link to={`/visualizarPerfil/${id}`} className=" bg-white py-1 w-20 lg:w-60 rounded-2xl text-[#859F74] border-2 border-[#859F74] flex items-center justify-center shadow hover:bg-[#859F74] hover:text-white transition ">
                            PERFIL
                        </Link>
                ...
                <div className="flex flex-col items-center justify-center bg-[#111411] rounded-4xl p-10 mx-20 my-5 shadow-2xl">
                    ...
                    <div className="flex flex-row items-center gap-4 mt-5">
                        <Link to={`/visualizarPerfil/${id}`} className=" bg-[#859F74] pw-20 lg:y-1 w-60 rounded-2xl text-[#ffffff] border-2 border-[#859F74] flex items-center justify-center shadow hover:bg-[#ffffff] hover:text-[#859F74] transition ">
                            PERFIL
                        </Link>
